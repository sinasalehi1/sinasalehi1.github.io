...
$('.arDb').on('click',function(){
  ...
  console.log(`text${index}`,`ntext${nindex}`)
  $('.t1').fadeOut('slow',function(){
    $('.t1').html(eval(`text${index}`))
  })
  $('.t2').fadeOut('slow',function(){
    $('.t2').html(eval(`text${nindex}`))
  })
